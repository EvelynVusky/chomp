...
entry:
  ...
  store %int_node* null, %int_node** %a, align 8
  ...
  store %int_node <{ i32 1, %int_node* null, i1 false }>, %int_node* %front_node_var, align 1
  ...
  store %int_node* %front_node_var, %int_node** %a, align 8
  %b = alloca i32, align 4
  store i32 0, i32* %b, align 4
  %a1 = load %int_node*, %int_node** %a, align 8
  %tmp = getelementptr inbounds %int_node, %int_node* %a1, i32 0, i32 2
  %tmp2 = load i1, i1* %tmp, align 1
  %cond = icmp eq i1 %tmp2, true
  br i1 %cond, label %then, label %else

merge:                                            ; preds = %else, %then
  %tmp3 = getelementptr inbounds %int_node, %int_node* %a1, i32 0, i32 0
  %tmp4 = load i32, i32* %tmp3, align 4
  store i32 %tmp4, i32* %b, align 4
  %b5 = load i32, i32* %b, align 4
  %printf6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @fmt, i32 0, i32 0), i32 %b5)
  ret i32 0
